...
axes.xaxis.set_ticks([numbers_powers[0]] + numbers_powers[16:N])
axes.xaxis.set_ticklabels(['1']+['2^'+str(k) for k in range(16,N)])
axes.yaxis.set_ticks([temps[0]] + temps[16:N])
axes.yaxis.set_ticklabels(['0']+[round(temps[k]) for k in range(16,N)])
...
axes.xaxis.set_ticks([numbers_powers[0]] + numbers_powers[16:N])
axes.xaxis.set_ticklabels(['1']+['2^'+str(k) for k in range(16,N)])
axes.yaxis.set_ticks([nounce[0]] + nounce[16:N])
axes.yaxis.set_ticklabels(['0']+[round(nounce[k]) for k in range(16,N)])
